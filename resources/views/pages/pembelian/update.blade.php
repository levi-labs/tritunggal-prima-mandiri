    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Form Edit Item Gudang</h5>
                        ...
                        @endif
                        <form action="{{ route('pembelian.update.item.gudang', $pembelian->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            {{-- @php
                                dd($pembelian->id);
                            ...
                            <div class="form-group">
                                ...
                                <select name="gudang" id="gudang" class="form-control">
                                    ...
                                    @foreach ($gudangs as $gudang)
                                        <option {{ $barang->gudang_id == $gudang->id ? 'selected' : '' }}
                                            value="{{ $gudang->id }}">{{ $gudang->nama }}</option>
                                    @endforeach
                                </select>
                                @error('gudang')
                                    <div class="text-danger">{{ $message }}</div>
